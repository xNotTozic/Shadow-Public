...
void InitializeModules() {
	...
	modules.push_back(new Killaura(Keys::C, false)); // C
	modules.push_back(new SpinAttack(Keys::P, false)); // P

	// Misc
	modules.push_back(new Disabler(Keys::NONE, false)); // NONE
	modules.push_back(new FastUse(Keys::NONE, false)); // NONE
	modules.push_back(new KickDecryptor(Keys::NONE, false)); // NONE
	modules.push_back(new Regen(Keys::NUM_0, false)); // NONE
	modules.push_back(new Timer(Keys::Z, false)); // V
	...
	modules.push_back(new Fly(Keys::F, false)); // F
	modules.push_back(new Sprint(Keys::NONE, false)); // Z
	modules.push_back(new Speed(Keys::X, false)); // Z
	modules.push_back(new TestFly(Keys::NONE, false)); // Z
	modules.push_back(new Velocity(Keys::NONE, false)); // NONE

	// Player
	modules.push_back(new AutoSpellbook(Keys::NONE, false)); // NONE
	modules.push_back(new ChestStealer(Keys::NONE, false)); // NONE
	modules.push_back(new ExperiencePoints(Keys::NONE, false)); // NONE
	modules.push_back(new InvMove(Keys::NONE, false)); // NONE
	...
	modules.push_back(new Animations(Keys::NONE, false)); // NONE
	...
	modules.push_back(new ServerRotations(Keys::NONE, false)); // NONE
	modules.push_back(new Trails(Keys::NONE, false)); // NONE
