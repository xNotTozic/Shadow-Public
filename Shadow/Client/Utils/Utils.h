...
#pragma region Folders and Assets
    ...
    std::string getClientPath(void) {
        ...
        std::string ClientFilePath = getRoamingStatePath() + "\\Shadow";
    ...
    void InitializeClientFolders() {
        Utils::downloadFile("https://raw.githubusercontent.com/xNotTozic/Shadow-Assets/main/Title.png", Utils::getResourcePath() + "\\Title.png");
    }
#pragma endregion
